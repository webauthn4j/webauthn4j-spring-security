...
let ProfileUpdateViewModel = function(){
    let _this = this;
    this._authenticatorListIndex = 0;
    $(document).ready(function() {
        //対応するViewがDOMに存在する場合
        if($('#profile-update-view').length){
            _this.setupEventListeners();
        }
    });
};

ProfileUpdateViewModel.prototype.addCredential = function (){
    let _this = this;
...
ProfileUpdateViewModel.prototype.setupEventListeners = function () {
    let _this = this;
